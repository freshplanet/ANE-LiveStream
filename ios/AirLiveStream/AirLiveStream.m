...
/*- (void) showBroadcastMenu {
    
    [self sendLog:@"setupBroadcastInterface"];
    
    UIScreen* externalScreen = [UIScreen mainScreen];
    CGRect screenBounds = externalScreen.bounds;
    
    _broadcastMenuWindow = [[UIWindow alloc] initWithFrame:screenBounds];
    _broadcastMenuWindow.rootViewController = [[BroadcastMenuViewController alloc] init];
    
    [_broadcastMenuWindow makeKeyAndVisible];
}*/
